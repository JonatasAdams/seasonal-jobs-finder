...
Isso vai:
1. Buscar as vagas na API filtrando por `emp_experience_reqd eq false`
2. Exibir uma tabela no terminal com: título, empresa, ETA Case Number, pagamento por hora, cidade/estado e link direto para a vaga
3. Salvar um arquivo `vagas.csv` na raiz do projeto com os mesmos dados
